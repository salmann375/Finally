...
<body>
	<header>
		<b><h3>Laporan Penemuan</h3></b>
	</header>
	<form action="prosespenemuan.php" method="POST" enctype="multipart/form-data"> 			
		<table>
			<tr>
				<td>Judul</td>
				<td>:</td>
			...
			<tr>
				...
				<td>:</td>
				<td><input type="datetime-local" name="waktutemu"/></td>
			</tr>
			<tr>
				<td>Tempat Ditemukan</td>
				<td>:</td>
				<td><input type="varchar" name="tempat" placeholder="Pojok MIPA"></td>
			</tr>
			<tr>
				<td>Foto</td>
				<td>:</td>
