...
include('config.php');
$id = $_GET['id'];
$query = mysqli_query($connect, "SELECT id, judul, tempat ,foto, kategori, subkategori, deskripsi, waktutemu, waktulapor, uname FROM laporan_penemuan WHERE id = $id");
...
<table border="1">
	...
	<tr>
		<?php
			...
			echo "<td>".$uname."</td>";
			echo "<td><a href = admin_accept.php?id=$id>Diterima</a></td>";
		?>
